...
public class addTeacher extends HttpServlet {
        ...
        String addTeacher = "INSERT INTO teachers (NAME, SURNAME, SUBJECT_NAME, STUPEN) VALUES (?,?,?,?)";
        ...
        public void init() throws ServletException {
            try {
                ...
                ps = conn.prepareStatement(addTeacher);
...
//
                ...
                value=request.getParameter("subject4");
                ps.setString(3, value);
                value=request.getParameter("stupin4");
